...
export default function ProgramDashboard() {
  ...
  return (
    <div>
      {/* Header */}
      <div className="bg-emerald-1000/80 p-4 shadow-lg rounded-xl">
        <div className="flex flex-col">
          {/* Top row with login button */}
          <div className="flex justify-end mb-4">
            <Button 
              variant="outline" 
              className="bg-emerald-950/50 border-emerald-600/30 text-emerald-50 hover:bg-emerald-800/50 rounded-lg"
